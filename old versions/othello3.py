...
class GreedyComputerPlayer(Player):
    def get_move(self, board, player):
...
black_player = GreedyComputerPlayer()  # Computer plays as Black
#black_player = RandomComputerPlayer()  # Random computer plays as Black
# black_player = HumanPlayer()  # Human plays as Black

#white_player = GreedyComputerPlayer()  # Computer plays as White
# white_player = RandomComputerPlayer()  # Random computer plays as White
